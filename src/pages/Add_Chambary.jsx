...
function Add_Chambary() {
  useEffect(()=>{
    fetch();
  },[])
  const [data , setData] = useState([])
  const fetch = async()=>{
    const result = await axios.get(`http://localhost:3000/chambary`)
  ...
  i.preventDefault();
  const res = await axios.post(`http://localhost:3000/chambary`, form)
  console.log(res)
  if(res.status == 201)
  {
