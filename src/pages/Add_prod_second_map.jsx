...
function Add_prod_second_map() {
  ...
  const submitHandel = async (e) => {
    ...
    e.preventDefault();
    if (validation()) {
      const res = await axios.post(`http://localhost:3000/polo_shirt`, formvalue);
      console.log(res);
      if (res.status == 201) {
...
export default Add_prod_second_map;
