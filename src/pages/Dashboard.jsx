    ...
    <div className="row column4 graph">
        ...
        <div className="dash_blog">
          <div className="dash_blog_inner">
            <div className="dash_head">
              <h3><span><i className="fa fa-calendar" /> 6 July 2018</span><span className="plus_green_bt"><a href="#">+</a></span></h3>
            </div>
      ...
      <div className="col-md-6">
        <div className="dash_blog">
          <div className="dash_blog_inner">
            <div className="dash_head">
              <h3><span><i className="fa fa-comments-o" /> Updates</span><span className="plus_green_bt"><a href="#">+</a></span></h3>
            </div>
            <div className="list_cont">
